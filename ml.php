<?php
/**
 * @see https://stovepipe.systems/post/machine-learning-naive-bayes
 */
...
class Classifier
{
    ...
    public function guess($statement)
    {
        ...
        foreach ($this->types as $type) {
            $likelihood = $this->totalP($type); // calculate P(Type)
    ...
    {
        return preg_split('/\s+/', preg_replace('/[^А-Яа-яA-Za-z0-9\s]/', '', strtolower($string)));
    }
}
